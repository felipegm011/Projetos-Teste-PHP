...
<head>	
	...
	<body id="container">
		...
		<form action="sessao.php" method="POST" name="form">
		...
		<div id="painel">
		  ...
		  <div class="form-group">
			...
			<input type="text"  id="usua" aria-describedby="emailHelp" placeholder="Seu Nome" name="usuario" class="form-control" required>
		  </div>
		  
		  <div class="form-group">
			<!--<label for="exampleInputEmail1">Senha</label>-->
			<input type="password"  id="senha1" aria-describedby="emailHelp" placeholder="Sua Senha" name="senha" class="form-control" required>
		  </div>
		  ...
		  <div class="form-group">
			<!--<label for="exampleInputEmail1">Redigite a Senha</label>-->
			<input type="text"  id="email" aria-describedby="emailHelp" placeholder="Digite seu E-mail" name="email" class="form-control" onblur="valida()" required/>
		  </div>
