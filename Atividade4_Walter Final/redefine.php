...
<head>	
	...
	<body id="redefine">
		...
		<form action="redefine2.php" method="POST" name="form" autocomplete="off">
		...
		<h1>Redefina seu Usuário e Senha</h1>
		 ...
		 <div class="form-group">
			...
			<input type="text" id="usua" aria-describedby="emailHelp" placeholder="Seu Nome" name="user" class="form-control" required autocomplete="off">
		  </div>
		  
		  <div class="form-group">
			<!--<label for="exampleInputEmail1">Senha</label>-->
			<input type="password"  id="senha1" aria-describedby="emailHelp" placeholder="Sua Senha" name="nsenha" class="form-control" required autocomplete="off">
		  </div>
